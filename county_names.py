...
The data acquired here can be fed into the scrape_statistical_atlast_county.py file, so
that we can acquire the information about each county.
"""
...
pickle_out = open("county_hrefs","wb")
